function [Target_GridMaxArea]=APITAggregation_fst_def(X,TableNodesOutside, TableNodesInside, Indices, H)
...
%RefpointCoutside=[i X(TableNodesOutside(j,4),1)
%X(TableNodesOutside(j,4),2) 0]
    if(isempty(RefpointAoutside)==0)
