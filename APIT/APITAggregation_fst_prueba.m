function [Target_GridMaxArea]=APITAggregation_fst_prueba(X,TableNodesOutside, TableNodesInside, Indices, H)
...
if(isempty(RefpointAoutside)==0) %Do the procedure of considering positive and negative areas when we have the two arrays, if we do not have TableNodesOutside we do not have Negativeareas and therefore we can not run the following lines
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%FOR POSITIVE NO REPETITIVE%%%%%%%%%%%%%%%%%%%%
    for j=1:m %size of Positiveareas
        no_reppos=0;
        %CODE ADDED JUNE 24TH 07%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
