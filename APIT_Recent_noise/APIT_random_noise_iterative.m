function [Error_total, Error, Error_2, Error_mult, size_EstimatedCoordinates_row, size_EstimatedCoordinatesr_row, size_Estimatedmult_row, AH, ND]=APIT_random_noise_iterative
% needed
tic
...
[TableNodesOutside, TableNodesOutsidetempo, TableNodesInside, Endprogram]=drawtriangles_noise_def(X,Audibleanchors,RSS_noise,Neighborhood,Indices);
...
%[TableNodesOutsideSurf, TableNodesInsideSurf, Estimatedcoord_density,  InOut_realinside, InOut_realoutside,  Endprogram]=APITtest_surface(X,Audibleanchors,RSS_noise,Neighborhood,Indices,H);
