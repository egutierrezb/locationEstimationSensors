...
%Distribution of one node per 1m of difference. Regular distro of anchors
%for i=1:10
%    for j=1:10
%        A(cont,:)=[i j];
%        cont=cont+1;
...
%Totally uniform random distributed
...
%This value is not used for the algorithm for APIT_random_noise
Radio_approx=1.7;
