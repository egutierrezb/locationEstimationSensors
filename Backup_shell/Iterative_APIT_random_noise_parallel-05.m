...
for a=1:num_iterations
     [Error_total(a), Error(a), Error_2(a),  Error_mult(a), size_Estimated1(a), size_Estimated2(a), size_Estimatedmult(a), AH(a), ND(a)]=APIT_random_noise_iterative_parallelD05(n);
 %    if(isdeployed)
 %        if (a==num_iterations)
 %              fclose(Results_file);
 %        end
...
letteri1=num2str(n);
letteri='DOI_0-5'
Nameofresults=strcat(letter1,letteri1,letteri,letter2);

save ("-mat7-binary", Nameofresults, "Error_total", "Error", "Error_2", "size_Estimated1", "size_Estimated2", "AH", "ND");
%if(isdeployed)
