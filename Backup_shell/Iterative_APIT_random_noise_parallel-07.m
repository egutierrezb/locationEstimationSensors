...
for a=1:num_iterations
     [Error_total(a), Error(a), Error_2(a),  Error_mult(a), size_Estimated1(a), size_Estimated2(a), size_Estimatedmult(a), AH(a), ND(a)]=APIT_random_noise_iterative_parallelD07(n);
 %    if(isdeployed)
 %        if (a==num_iterations)
 %              fclose(Results_file);
 %        end
