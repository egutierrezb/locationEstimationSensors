...
load("-text", "GeneralTopology.mat", "M", "N", "Res", "X", "Audibleanchors", "Pij", "Neighborhood", "Indices" ,"H", "TrueDist","Radio_approx");
...
Indices=NewAnchors;
save("-text", "GeneralTopology.mat","M","N","Res","X","Audibleanchors", "Pij", "Neighborhood", "Indices" ,"H", "TrueDist","Radio_approx");